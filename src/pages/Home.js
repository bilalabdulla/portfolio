...
}
{
      ...
      <section className='resu-section' id='resume'>
        ...
        <div className='resu-card'> 
              ...
              <p className='subject'>Software development</p>
      ...
      <section className='about' id='about'>
        <img src='/website-background.jpg' className='about-img'/>
        <div className='about-div'>
          ...
          <a href="/react.jpg" className='about-btn' download='react.jpg'>Download CV</a>
        </div>
      </section>
